...
import { IRegisterFormComponentState } from "./IRegisterFormComponentState";
...
class RegisterFormComponent extends React.Component<{},IRegisterFormComponentState> {
constructor(props:IRegisterFormComponentState){
   super(props);
   this.state={
      userName:"",
      email:"",
